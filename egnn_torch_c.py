...
# from egnn_pytorch import GlobalLinearAttention, exists, EGNN
...
class EGNN_NetworkC(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.token_emb = nn.Linear(feat_dim, dim) if exists(num_tokens) else None
